...
def show_result(screen, result):
    ...
    ft_surf1 = ft_font1.render(result, 1, (139, 0, 0))
    screen.blit(ft_surf1, (625, 250))
    ft_surf2 = ft_font1.render('按R重玩', 1, (139, 0, 0))
    screen.blit(ft_surf2, (625, 300))
...
def check(screen, color, gobang):
    ...
    ft_font1 = pygame.font.Font('font/方正.TTF', 40)
    ft_surf1 = ft_font1.render(final_text, 1, (255, 130, 71))
    screen.blit(ft_surf1, (625, 250))
...
def show_list(screen,gobang:list):
    ...
    for row in range(10):
        for col in range(10):
            ft_surf1 = ft_font1.render(str(gobang[col][row]), 1, (0, 0, 0))
